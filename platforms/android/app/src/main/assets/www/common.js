...
var AuthService = /** @class */ (function () {
    function AuthService(afAuth, db, router) {
        ...
        this.user = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (user) {
            if (user) {
                return _this.db.doc("users/" + user.uid).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (data) {
                    data['id'] = user.uid;
    ...
    AuthService.prototype.getinfore = function (val) {
        return this.db.doc("users/" + val).valueChanges();
    };
    AuthService.prototype.updatebalance = function (val) {
    ...
    AuthService.prototype.updatebalancere = function (user2, val) {
        return this.db.doc("users/" + user2).update(val);
    };
    AuthService.prototype.updateprofile = function (val) {
        // console.log('save: ', note);
        // if (note.notebook) {
        //   note.notebook = this.afs.doc(`/notebooks/${note.notebook.id}`).ref;
        // }
    ...
    AuthService.prototype.signUp = function (credentials) {
        var _this = this;
        return this.afAuth.auth.createUserWithEmailAndPassword(credentials.email, credentials.password).then(function (data) {
            return _this.db.doc("users/" + data.user.uid).set({
    ...
    AuthService.prototype.signIn = function (credentials) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(this.afAuth.auth.signInWithEmailAndPassword(credentials.email, credentials.password)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (user) {
            if (user) {
                return _this.db.doc("users/" + user.user.uid).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1));
            }
            else {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(null);
            }
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"]])
    ], AuthService);
    return AuthService;
}());
